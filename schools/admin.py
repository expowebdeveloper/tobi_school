...
class SchoolAdmin(admin.ModelAdmin):
    list_display = ('urn', 'establishment_name', 'local_authority', 'establishment_status', 'process')
    list_filter = ('local_authority', 'establishment_status', 'process')
    ...
    def changelist_view(self, request, extra_context=None):
        ...
        processed_percentage = (processed_count / total_schools * 100) if total_schools > 0 else 0
        not_processed_percentage = (not_processed_count / total_schools * 100) if total_schools > 0 else 0
...
class SchoolDataAdmin(admin.ModelAdmin):
    ...
    def changelist_view(self, request, extra_context=None):
        ...
        refined_percentage = (refined_count / total_count * 100) if total_count > 0 else 0
    ...
    def export_to_csv(self, request, queryset):
        ...
        self.message_user(request, f'Successfully exported {queryset.count()} entries to CSV.')
        return response
